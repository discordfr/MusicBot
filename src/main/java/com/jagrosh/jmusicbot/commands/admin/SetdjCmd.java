    ...
    protected void execute(CommandEvent event) 
    {
        ...
        else
        {
            ...
            else
            {
                ...
                event.reply(event.getClient().getSuccess()+" Les commandes de modération de la queue peuvent maintenant être utilisées par les utilisateurs avec le rôle **"+list.get(0).getName()+"**.");
            }
        }
    }
